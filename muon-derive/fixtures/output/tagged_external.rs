...
where
    T: Clone,
    V: muon::general::SerializeSnapshot,
{
    A(S),
    B(u32, U, V),
...
const _: () = {
        ...
        V: ::muon::general::SerializeSnapshot + ::serde::Serialize,
    {
        ...
        where
            ...
            ::muon::observe::DefaultObserver<'ob, U>: ::muon::observe::Flush<Sk>,
            ::muon::general::SnapshotObserver<'ob, V, V>: ::muon::observe::Flush<Sk>,
        {
            match self {
                Self::A(_) => {}
                Self::B(u0, u1, u2) => {
                    ...
                    sink.pop_segment();
                    sink.push_index(2usize);
                    ::muon::observe::Flush::flush(u2, sink);
                    sink.pop_segment();
                    sink.pop_segment();
                }
                Self::C { qux, .. } => {
    ...
    > ::muon::observe::QuasiSink<Sk> for FooObserver<'ob, S, T, U, V, _S, N>
    where
        T: Clone,
        V: muon::general::SerializeSnapshot,
        U: ::muon::Observe + 'ob,
    ...
    impl<
        ...
        Sk: ::muon::observe::Sink + ?Sized,
        Elem: ?Sized,
    > ::muon::observe::FlushWith<Sk, Elem> for FooObserver<'ob, S, T, U, V, _S, N>
    where
        Foo<S, T, U, V>: ::muon::helper::serde::Serialize + 'static,
        T: Clone,
        V: muon::general::SerializeSnapshot,
    ...
    impl<
        ...
        N,
        Sk: ::muon::observe::Sink + ?Sized,
    > ::muon::observe::Flush<Sk> for FooObserver<'ob, S, T, U, V, _S, N>
    where
        Foo<S, T, U, V>: ::muon::helper::serde::Serialize + 'static,
        T: Clone,
        V: muon::general::SerializeSnapshot,
