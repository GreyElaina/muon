    ...
    S: AsDerefMut<D, Target = Url>,
{
    ...
    pub fn set_fragment(&mut self, fragment: Option<&str>) {
        ...
        let preserved = value
            .fragment()
            .map_or(str.len(), |f| Self::offset(str, f) - 1);
    ...
    pub fn set_port(&mut self, port: Option<u16>) -> Result<(), ()> {
        ...
        let preserved = value
            .host_str()
            .map_or(0, |h| Self::offset(str, h) + h.len());
        self.state.mark_truncate(str, preserved);
        value.set_port(port)
    }
...
mod tests {
    ...
    fn replace_on_deref_mut() {
        ...
        *ob.tracked_mut() = Url::parse("https://other.com").unwrap();
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/path", "after": "https://other.com/"}]),
        );
    }
    ...
    fn set_fragment_appends() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/path", "after": "https://example.com/path#section"}]),
        );
    }
    ...
    fn set_fragment_replaces_existing() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/path#old", "after": "https://example.com/path#new"}]),
        );
    }
    ...
    fn remove_fragment_truncates() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/path#frag", "after": "https://example.com/path"}]),
        );
    }
    ...
    fn set_query_appends() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/path", "after": "https://example.com/path?key=val"}]),
        );
    }
    ...
    fn set_query_with_fragment() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/path#frag", "after": "https://example.com/path?key=val#frag"}]),
        );
    }
    ...
    fn set_scheme_replaces() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/path", "after": "http://example.com/path"}]),
        );
    }
    ...
    fn set_path_replaces_suffix() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/old", "after": "https://example.com/new"}]),
        );
    }
    ...
    fn set_host() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com/path", "after": "https://other.org/path"}]),
        );
    }
    ...
    fn set_port() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://example.com:8080/path", "after": "https://example.com/path"}]),
        );
    }
    ...
    fn set_username() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://user@example.com/path", "after": "https://admin@example.com/path"}]),
        );
    }
    ...
    fn set_password() {
        ...
        assert_eq!(
            changes.into_json(),
            json!([{"path": [], "before": "https://user:secret@example.com/path", "after": "https://user:pw@example.com/path"}]),
        );
    }
}
